...
export const companyAddressConfig: CompanyFieldConfig[] = [
  {
    label: 'company.descricaoTipoDeLogradouro',
    value: 'descricaoTipoDeLogradouro',
    type: 'text',
  },
...
export const companyFieldsConfig: CompanyFieldConfig[] = [
  {
    label: 'company.identificadorMatrizFilial',
    value: 'identificadorMatrizFilial',
    type: 'text',
  },
  {
    label: 'company.descricaoMatrizFilial',
    value: 'descricaoMatrizFilial',
    type: 'text',
  },
  { label: 'company.nomeFantasia', value: 'nomeFantasia', type: 'text' },
  {
    label: 'company.situacaoCadastral',
    value: 'situacaoCadastral',
    type: 'text',
  },
  {
    label: 'company.descricaoSituacaoCadastral',
    value: 'descricaoSituacaoCadastral',
    type: 'text',
  },
  {
    label: 'company.dataSituacaoCadastral',
    value: 'dataSituacaoCadastral',
    type: 'date',
  },
  {
    label: 'company.motivoSituacaoCadastral',
    value: 'motivoSituacaoCadastral',
    type: 'text',
  },
  {
    label: 'company.nomeCidadeExterior',
    value: 'nomeCidadeExterior',
    type: 'text',
  },
  {
    label: 'company.codigoNaturezaJuridica',
    value: 'codigoNaturezaJuridica',
    type: 'text',
  },
  {
    label: 'company.dataInicioAtividade',
    value: 'dataInicioAtividade',
    type: 'date',
  },
  { label: 'company.cnaeFiscal', value: 'cnaeFiscal', type: 'text' },
  {
    label: 'company.cnaeFiscalDescricao',
    value: 'cnaeFiscalDescricao',
    type: 'text',
  },
  ...
  {
    label: 'company.qualificacaoDoResponsavel',
    value: 'qualificacaoDoResponsavel',
    type: 'text',
  },
  ...
  {
    label: 'company.opcaoPeloSimples',
    value: 'opcaoPeloSimples',
    type: 'boolean',
  },
  {
    label: 'company.dataOpcaoPeloSimples',
    value: 'dataOpcaoPeloSimples',
    type: 'date',
  },
  {
    label: 'company.dataExclusaoDoSimples',
    value: 'dataExclusaoDoSimples',
    type: 'date',
  },
  { label: 'company.opcaoPeloMei', value: 'opcaoPeloMei', type: 'boolean' },
  {
    label: 'company.situacaoEspecial',
    value: 'situacaoEspecial',
    type: 'text',
  },
  {
    label: 'company.dataSituacaoEspecial',
